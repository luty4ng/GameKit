...
namespace EditorTool {
    public class ExcelBuild : Editor {
        ...
        public static void Debug() {
            ...
            ExcelTool.CreateCode(ExcelConfig.excelPath + "ItemData.xlsx");
            ExcelTool.CreateAsset(ExcelConfig.excelPath + "ItemData.xlsx");
            // ExcelTool.Code2Asset(ExcelConfig.excelPath + "ItemData.xlsx");
        }
