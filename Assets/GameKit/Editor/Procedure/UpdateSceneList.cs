...
public static class UpdateSceneList
{
    static readonly string scriptPath = "GameKit/Editor/Procedure/ScenesList.cs";

    [MenuItem("SceneManagement/UpdateSceneList")]
    public static void UpdateList()
    {
        ...
        foreach (string sceneGuid in AssetDatabase.FindAssets("t:Scene", new string[] { "Assets" }))
        {
            ...
            string methodName = scenePath.Replace('/', '_').Replace('\\', '_').Replace('.', '_').Replace('-', '_');
    ...
    public static void OpenScene(string filename)
    {
        if (EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo())
        {
            ...
            // EditorSceneManager.OpenScene("Assets/GameMain/Scenes/Procedure/Procedure.unity", OpenSceneMode.Single);
